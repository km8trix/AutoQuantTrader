...
unreachable injected lifecycle-v2 implementation: canonical authority/channel
...
exact exit-2 no-effect target and the trader remains `not_ready`. Phases 7 and 8
remain operationally ahead.
