...
> Planning was consolidated on 2026-09-08. [Architecture](docs/ARCHITECTURE.md) and [implementation waves](docs/IMPLEMENTATION_PLAN.md) are the only current design and roadmap. The workflows below describe the existing code; planning targets are not yet implemented.
