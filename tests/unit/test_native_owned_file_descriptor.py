...
_EXPECTED_SDIST_FORCE_INCLUDE = frozenset(
    {
...
def test_packaging_matrix_and_production_image_gate_are_explicit() -> None:
    ...
    assert frozenset(sdist_force_include) == _EXPECTED_SDIST_FORCE_INCLUDE
...
def test_static_launcher_profiles_and_sdist_inputs_are_exact() -> None:
    ...
    assert frozenset(force_include) == _EXPECTED_SDIST_FORCE_INCLUDE
