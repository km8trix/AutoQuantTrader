    ...
    items: [
      {
        ...
        description: 'Reference strategies and configurations',
      },
      {
        label: 'Research runs',
        path: '/research/backtests',
        icon: AssessmentRoundedIcon,
        description: 'Registered datasets, worker reports and comparisons',
      },
      {
        label: 'Experiments',
        path: '/research/experiments',
        icon: HubRoundedIcon,
        description: 'Descriptive windows, prior access and cost trials',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        path: '/research/history/strategies',
        icon: ScienceRoundedIcon,
        description: 'Retained fixture strategy catalog',
      },
      {
        label: 'Golden diagnostics',
        path: '/research/history/backtests',
        icon: AssessmentRoundedIcon,
        description: 'Historical golden fixture workflow',
      },
      {
        label: 'Governance diagnostics',
        path: '/research/history/experiments',
        icon: HubRoundedIcon,
        description: 'Retained experiment governance evidence',
      },
    ],
  },
  {
